...
class DIR_VIEW : ELEMENT
{
    ...
    void Engage()
    {
        ...
        builder.addFromFile(Config.GetValue("dir_view", "glade_file", ConfigPath("elements/resources/dirview.glade")));
		...
		AddIcon("dir_view_up", ConfigPath("elements/resources/navigation-090-frame.png"));
		AddIcon("dir_view_refresh", ConfigPath("elements/resources/arrow-circle-double-135.png"));
		AddIcon("dir_view_home", ConfigPath("elements/resources/home.png"));
		AddIcon("dir_view_sync", ConfigPath("elements/resources/navigation-270-frame.png"));
		AddIcon("dir_view_hidden_true", ConfigPath("elements/resources/eye-close.png"));
		AddIcon("dir_view_hidden_false", ConfigPath("elements/resources/eye.png"));
		AddIcon("dir_view_folder", ConfigPath("elements/resources/folder.png"));
		AddIcon("dir_view_file", ConfigPath("elements/resources/document.png"));
		AddIcon("dir_view_file_d", ConfigPath("elements/resources/document-attribute-d.png"));
